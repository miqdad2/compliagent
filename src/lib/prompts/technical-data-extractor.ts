...
Context: Evidence may be functional, technical, numeric, certification-based, or installation-dependent. Preserve exact evidence text and its stored source region for condition-level matching.
